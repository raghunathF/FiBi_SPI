...
void config_pins()
{
	...
	config_port_pin.direction  = PORT_PIN_DIR_OUTPUT;
	port_pin_set_config(LEFT_MOTOR_CLOCK_PIN, &config_port_pin);
	port_pin_set_config(LEFT_MOTOR_ANTI_PIN, &config_port_pin);
	port_pin_set_config(RIGHT_MOTOR_CLOCK_PIN, &config_port_pin);
	port_pin_set_config(RIGHT_MOTOR_ANTI_PIN, &config_port_pin);
	port_pin_set_output_level(LEFT_MOTOR_CLOCK_PIN, false);
	port_pin_set_output_level(LEFT_MOTOR_ANTI_PIN, false);
	port_pin_set_output_level(RIGHT_MOTOR_CLOCK_PIN, false);
